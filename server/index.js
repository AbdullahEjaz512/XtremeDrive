...
async function initialize() {
  try {
    // Import Prisma and create client
    ...
    // Store prisma in app.locals
    app.locals.prisma = prisma;
    console.log('Prisma stored in app.locals');
    ...
    async function seedData(prismaClient) {
      try {
        if (!prismaClient || !prismaClient.user) {
          console.log('Skipping seed data - Prisma client not ready');
          return;
        }
